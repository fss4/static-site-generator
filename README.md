...
If the site is ready to be published to the internet this can be done easily via GitHub pages by following these steps.
...
6. Go to settings in the repository in the browser and under **Code and Automation** go to the **Pages** tab.
7. Set the branch to that of the GitHub repo you've created (there should only be one if you are using a brand new repo it is likely either `main` or `master`).
